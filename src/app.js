import { calculateStats, normalizeMultiTrainerRoster, normalizePlayerCollection, normalizePlayerPartnerRoster, normalizeTrainerRoster, snapshotFingerprint } from "./adapters/combatant_ingest.js?v=20260917-unbound-escorts-v1";
...
import { canonicalSpeciesDisplayName, loadStandardizedDataset } from "./adapters/standardized_dataset.js?v=20260917-unbound-escorts-v1";
import { loadTrainerAiBootstrap } from "./adapters/trainer_ai.js?v=20260917-unbound-escorts-v1";
...
import { SavedDraftStore, savedDraftSnapshot } from "./cache/saved_drafts.js?v=20260917-unbound-escorts-v1";
import { reorderCards } from "./ui/reorder_cards.js?v=20260909-public-release-v2";
import { addFreeCalcBranch, editFreeCalcCombatant, replaceFreeCalcSlot, freeCalcAsNewPlan } from './core/free_calc.js?v=20260917-unbound-escorts-v1';
import { belongsToSlotParty, eligibleReserves, partyOwnerForSlot } from './core/party_ownership.js?v=20260909-public-release-v2';
import { downloadPlan, exportSelectedPlan, migratePlanDocument, parsePlan } from "./contracts/plan_file.js?v=20260917-unbound-escorts-v1";
import { assertValidPlanDocument } from "./contracts/plan_contract.js?v=20260917-unbound-escorts-v1";
import { mechanicsCompatibility, validatePlanReferences } from "./contracts/plan_compatibility.js?v=20260917-unbound-escorts-v1";
...
import { exportBranchGroups, planTreeOrder, planTurnTreeOrder, preferredImportedReviewStateId, stateLineage, turnNodeVisuals } from "./core/graph.js?v=20260917-unbound-escorts-v1";
...
import { createPlanDocument, planHasWork, setStateNodeNote, upgradeInitialEntryEffects } from "./core/plan.js?v=20260917-unbound-escorts-v1";
import { commitForcedReplacement, commitLabel, commitPreview, previewForcedReplacement, refreshUnknownCommittedProbabilities, repairStaleLeafBattleEnd, replacementCommitLabel } from "./core/planner.js?v=20260917-unbound-escorts-v1";
import { recalculatePlanDocument } from "./core/recalculation.js?v=20260917-unbound-escorts-v1";
import { upgradeImportedPlanForEditing } from "./core/import_upgrade.js?v=20260917-unbound-escorts-v1";
...
import { experienceForLevel, experienceToNextLevel, projectExperience } from "./rulesets/vw2r_experience.js?v=20260917-unbound-escorts-v1";
import { ResolverWorkerClient } from "./worker/resolver_client.js?v=20260917-unbound-escorts-v1";
...
import { addImportedPlanParty, bindPlanPlayerPartyToImportedBox } from "./boxes/plan_import.js?v=20260917-unbound-escorts-v1";
import { applyBranchProgressionToLibrary, branchProgressionSnapshot } from "./boxes/progression.js?v=20260917-unbound-escorts-v1";
...
function renderCombatantCard(side, slot, { displaySlot = slot } = {}) {
  ...
  if (side === "player" && !mon.source?.isPlayerPartner && Number.isInteger(monState.experience) && mon.growthRate) {
...
function wireEvents() {
  ...
  byId("player-partner-select").addEventListener("change", () => { renderPlayerPartnerSelection(); updateBeginAvailability(); });
