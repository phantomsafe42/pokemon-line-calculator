...
import { loadTrainerAiBootstrap } from "./adapters/trainer_ai.js?v=20260920-held-item-activation-v2";
...
import { addFreeCalcBranch, editFreeCalcCombatant, replaceFreeCalcSlot, freeCalcAsNewPlan } from './core/free_calc.js?v=20260920-held-item-activation-v2';
import { isSandbox, editSandboxCombatant, placeSandboxCombatant, admitSandboxReserve } from './core/sandbox.js?v=20260920-held-item-activation-v2';
...
import { mechanicsCompatibility, validatePlanReferences } from "./contracts/plan_compatibility.js?v=20260920-held-item-activation-v2";
...
import { formatDamageRollCounts, healingEventDescription, isCriticalOhkoOutcome, isHighRollKoOutcome, outcomePanelEvents, readableMechanicName } from "./core/outcome_presentation.js?v=20260920-held-item-activation-v2";
...
import { upgradeImportedPlanForEditing } from "./core/import_upgrade.js?v=20260920-held-item-activation-v2";
...
import { ResolverWorkerClient } from "./worker/resolver_client.js?v=20260920-held-item-activation-v2";
