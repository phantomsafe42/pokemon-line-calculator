...
import { mechanicsCompatibility, validatePlanReferences } from "./contracts/plan_compatibility.js?v=20260917-partners-release-v1";
...
import { formatDamageRollCounts, healingEventDescription, isCriticalOhkoOutcome, isHighRollKoOutcome, outcomePanelEvents, readableMechanicName } from "./core/outcome_presentation.js?v=20260920-empty-slot-events-v1";
