...
import { actionSignature, nextCreatedOrder, touchPlan, updateStateHash } from "./plan.js?v=20260917-unbound-escorts-v1";
import { clone, shortHash, stableStringify } from "./primitives.js?v=20260905-drafts-freecalc-partners-v1";
import { resolveForcedReplacement, resolveTurn } from "./resolver.js?v=20260917-unbound-escorts-v1";
