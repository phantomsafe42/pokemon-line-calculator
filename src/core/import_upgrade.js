...
import { upgradeInitialEntryEffects } from "./plan.js?v=20260920-held-item-activation-v2";
import { recalculatePlanDocument } from "./recalculation.js?v=20260920-held-item-activation-v2";
