...
import { upgradeInitialEntryEffects } from "./plan.js?v=20260917-player-partners-v1";
import { recalculatePlanDocument } from "./recalculation.js?v=20260917-player-partners-v1";
