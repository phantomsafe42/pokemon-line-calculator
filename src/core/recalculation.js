...
import { commitForcedReplacement, commitPreview, previewForcedReplacement } from "./planner.js?v=20260917-unbound-escorts-v1";
import { updateStateHash, upgradeInitialEntryEffects } from "./plan.js?v=20260917-unbound-escorts-v1";
import { addFreeCalcBranch } from './free_calc.js?v=20260917-unbound-escorts-v1';
import { currentMechanicsFingerprint } from "../rulesets/resolver_profile.js?v=20260911-ability-storage-reimp-v1";
import { calculateStats, normalizeMultiTrainerRoster, normalizeTrainerRoster } from "../adapters/combatant_ingest.js?v=20260917-unbound-escorts-v1";
