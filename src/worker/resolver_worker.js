...
async function initialize(datasetBaseUrl, datasetHostedPrefix, trainerAiBaseUrl, trainerAiHostedPrefix, trainerAiLazyResources, hostedRelease, gameId, role) {
  ...
  const datasetModule = await import("../adapters/standardized_dataset.js?v=20260917-encounter-format-v1");
  ...
  if (role === "resolver") {
    ...
    const trainerAiModule = await import("../adapters/trainer_ai.js?v=20260917-encounter-format-v1");
