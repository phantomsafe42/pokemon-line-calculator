...
The accepted current build implements Stages 1 through 7 of the battle-planner specification plus the tested schema-v2 Singles/Doubles extension, game-first Boxes library, EXP planning, complete VW2R move adapter, and calculator-interface redesign. The build includes:
